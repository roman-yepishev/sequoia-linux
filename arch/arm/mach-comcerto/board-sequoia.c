/*
 * arch/arm/mach-comcerto/board-sequoia.c
 *
...
static struct comcerto_pfe_platform_data comcerto_pfe_pdata = {
	.comcerto_eth_pdata[0] = {
		...
		.bus_id = 0,
		// WDMyCloud: JO: Using Broadcom phy at address = 0...
		.phy_id = 0,
		.gem_id = 0,
	...
	.comcerto_mdio_pdata[0] = {
		.enabled = 1,
		// WDMyCloud: JO: address...?
		.phy_mask = 0xFFFFFF00,
		.mdc_div = 96,
		.irq = {
			// WDMyCloud: jo: Changed to match phy number for broadcom phy above...
			[0] = PHY_POLL,
		},
	},
};
...
MACHINE_START(COMCERTO, "Sequoia")
